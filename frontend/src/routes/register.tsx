          ...
          <div className="max-w-xl">
            ...
            <h1 className="text-4xl font-semibold leading-[1.08] tracking-tight text-white xl:text-6xl">
              ...
              <span className="block text-slate-400">
                into recovered growth.
              </span>
            </h1>

            <p className="mt-6 max-w-lg text-base leading-7 text-slate-400 xl:text-lg">
              Build a smarter recovery workflow that detects revenue
              leakage, evaluates recovery strategies, and measures
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-500">
              Start recovering lost revenue with REVIVE AI.
            </p>
          </div>
